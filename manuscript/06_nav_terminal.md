...
![Locating the Terminal in RStudio Cloud](images/06_nav_terminal/06_fileorganization_nav_terminal-1.png)

When you click on this tab, you will see a pane that looks as follows:

![The Terminal prompt](images/06_nav_terminal/06_fileorganization_nav_terminal-2.png)
...
![Definitions: working directory and path](images/06_nav_terminal/06_fileorganization_nav_terminal-5.png)
...
![Relative path](images/06_nav_terminal/06_fileorganization_nav_terminal-6.png)
...
![Absolute path](images/06_nav_terminal/06_fileorganization_nav_terminal-7.png)
...
![pwd command](images/06_nav_terminal/06_fileorganization_nav_terminal-10.png)
...
![ls command](images/06_nav_terminal/06_fileorganization_nav_terminal-11.png)
...
![ls command](images/06_nav_terminal/06_fileorganization_nav_terminal-12.png)
...
![cd command](images/06_nav_terminal/06_fileorganization_nav_terminal-13.png)
...
![cd command](images/06_nav_terminal/06_fileorganization_nav_terminal-14.png)

If you try to change directory to a nonexistent folder, you will get an error message that looks as below:

![Error with the cd command](images/06_nav_terminal/06_fileorganization_nav_terminal-15.png)
...
![Absolute paths are not portable](images/06_nav_terminal/06_fileorganization_nav_terminal-16.png)
...
![Additional example for relative paths](images/06_nav_terminal/06_fileorganization_nav_terminal-18.png)
...
![Wildcard operator](images/06_nav_terminal/06_fileorganization_nav_terminal-20.png)
...
![Copying a single file](images/06_nav_terminal/06_fileorganization_nav_terminal-21.png)
...
![Copying multiple files](images/06_nav_terminal/06_fileorganization_nav_terminal-22.png)
...
![Copying a folder](images/06_nav_terminal/06_fileorganization_nav_terminal-23.png)
...
![Moving a single file](images/06_nav_terminal/06_fileorganization_nav_terminal-24.png)
...
![Moving multiple files](images/06_nav_terminal/06_fileorganization_nav_terminal-25.png)
...
![Moving and renaming a folder](images/06_nav_terminal/06_fileorganization_nav_terminal-26.png)
...
![Deleting files](images/06_nav_terminal/06_fileorganization_nav_terminal-27.png)
...
![Deleting a folder](images/06_nav_terminal/06_fileorganization_nav_terminal-28.png)
...
![Creating a new file](images/06_nav_terminal/06_fileorganization_nav_terminal-29.png)
...
![Creating a new directory](images/06_nav_terminal/06_fileorganization_nav_terminal-30.png)
