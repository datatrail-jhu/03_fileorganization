...
![relative path to dataset.csv](images/08_paths_in_code/08_fileorganization_paths_in_code-6.png)
...
![here() does not care what your current working directory is](images/08_paths_in_code/08_fileorganization_paths_in_code-11.png)
...
![using here to get a file path](images/08_paths_in_code/08_fileorganization_paths_in_code-2.png)
