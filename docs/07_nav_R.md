...
{choose-answers: 4}
?2 Which of the following R function and Terminal command pairs perform the same function? (Note: The R function is represented by `function()`, where the Terminal command does not have the parentheses `function`.)
